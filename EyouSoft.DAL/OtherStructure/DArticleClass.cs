...
{
    public class DArticleClass : EyouSoft.Toolkit.DAL.DALBase, EyouSoft.IDAL.IArticleClass
    {
        #region 初始化db
        ...
        public EyouSoft.Model.MArticleClass GetModel(int ClassId)
        {
            ...
            using (IDataReader dr = DbHelper.ExecuteReader(cmd, this._db))
            {
                while (dr.Read())
                {
                    ...
                    model.IsSystem = !dr.IsDBNull(dr.GetOrdinal("IsSystem")) ? (EyouSoft.Model.Enum.ArticleType)dr.GetInt32(dr.GetOrdinal("IsSystem")) : (EyouSoft.Model.Enum.ArticleType)0;
