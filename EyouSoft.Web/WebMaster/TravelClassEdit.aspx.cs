...
{
    public partial class TravelClassEdit : Common.Page.WebmasterPageBase
    {
        ...
        private string Save(string action, string tid)
        {
            ...
            var model = new Model.MArticleClass
            {
                ...
                IsSystem = (EyouSoft.Model.Enum.ArticleType)Utils.GetInt(Utils.GetFormValue(this.hidIsSystme.UniqueID))
            };
