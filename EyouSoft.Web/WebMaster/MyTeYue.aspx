<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyTeYue.aspx.cs" Inherits="EyouSoft.Web.WebMaster.MyTeYue" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        QuXiao: function(obj) {
            ...
            var url = "/WebMaster/MyTeYue.aspx?dotype=del&id=" + id;
            pageData.GoAjax(url);
        },
        Tianjia: function(obj) {
            var id = $(obj).attr("data-id");
            var url = "/WebMaster/MyTeYue.aspx?dotype=add&id=" + id;
            pageData.GoAjax(url);
        },
        GoAjax: function(url) {
            $.newAjax({
