<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DingDanList.aspx.cs" Inherits="EyouSoft.Web.WebMaster.DingDanList" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="searchbox">
                        <label>
                            订单类型：</label>
                        <select id="OrderType" name="OrderType" class="inputselect" style="width: 120px">
                            <%=BindOrderType(EyouSoft.Common.Utils.GetQueryStringValue("OrderType"))%>
                        </select>
                        <label>
                            交易日期：</label>
                ...
                <asp:Repeater runat="server" ID="rptList">
                    <ItemTemplate>
                        <tr class="<%# Container.ItemIndex % 2 == 0 ? "even" : "odd"%>">
                            ...
                            <td align="center">
                                <a href="javascript:;" class="AgencyId" data-id="<%# Eval("AgencyId").ToString().Trim()%>">
                                    <%# GetWangDianByID(Eval("AgencyId"))%></a>
                            </td>
                            <td align="left">
                                <a href="javascript:;" class="OrderName" data-id="<%# Eval("ProductID").ToString().Trim()%>">
                                    <%#(EyouSoft.Common.Utils.ConverToStringByHtml(Eval("OrderName").ToString()))%></a>
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                             <%# ((EyouSoft.Model.OtherStructure.DingDanType)(int)(Eval("OrderType"))) == EyouSoft.Model.OtherStructure.DingDanType.团购订单 ? "0" : (Eval("AgencyId").ToString().Trim().Length > 20 ? (Convert.ToDouble(Eval("JinE")) - Convert.ToDouble(Eval("AgencyJinE"))).ToString("f2") : "0")%>元
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <%#Eval("LXRName")%><br />
                                <a href="javascript:;" class="LXRMoblie" data-id="<%# Eval("LXRMoblie").ToString().Trim()%>">
                                    <%#Eval("LXRMoblie")%></a>
                            </td>
                            <td align="center">
                                <%# GetStatus(Eval("OrderStatus"), Eval("AgencyId"), Eval("OrderType"))%>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
