                ...
                <asp:Repeater runat="server" ID="rptList">
                    <ItemTemplate>
                        <tr class="<%#Container.ItemIndex%2==0 ? "even":"odd" %>" data-id='<%#Eval("ClassId") %>'
                            data-is='<%#(int)Enum.Parse(typeof(EyouSoft.Model.Enum.ArticleType), Eval("IsSystem").ToString())%>'>
                            <td align="center">
                                <%# GetIndex(Container.ItemIndex)%>
                            </td>
                            <td align="center">
                                <font <%#(int)Enum.Parse(typeof(EyouSoft.Model.Enum.ArticleType), Eval("IsSystem").ToString()) == 0 ? "" : "style='color:Red'"%>>
                                    <%#Eval("ClassName")%>
                                </font>
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <%#(int)Enum.Parse(typeof(EyouSoft.Model.Enum.ArticleType), Eval("IsSystem").ToString()) == 0 
                                    ? "<a href=\"javascript:;\" class=\"update_bar\">修改 </a>|<a href=\"javascript:;\" class=\"delete_bar\">删除</a>"
                                   : "<a href=\"javascript:;\" class=\"update_bar\">修改 </a>"
                                %>
                            </td>
                        </tr>
                    </ItemTemplate>
        ...
        var RouteTheme = {
            ...
            BindBtn: function() {
                $("#add_bar").click(function() {
                    RouteTheme.ShowBoxy({ iframeUrl: "/WebMaster/TravelClassEdit.aspx?action=add", title: "新增旅游资讯类别", width: "550px", height: "180px" });
                    return false;
                })
                $(".update_bar").click(function() {
                    var tid = $(this).closest("tr").attr("data-id");
                    RouteTheme.ShowBoxy({ iframeUrl: "/WebMaster/TravelClassEdit.aspx?action=edit&tid=" + tid, title: "修改旅游资讯类别", width: "550px", height: "180px" });
                    return false;
                })
