...
{
    public partial class MyTeYue : EyouSoft.Common.Page.WebmasterPageBase
    {
        #region 分页参数
        ...
        void initList()
        {
            ...
            var list = new EyouSoft.BLL.MemberStructure.BMember().GetMyDaiLi(GYSid, pageIndex, pageSize, model);
            recordCount = new EyouSoft.BLL.MemberStructure.BMember().GetMyDaiLiNum(GYSid, model);
        ...
        private string AddMyDaiLi()
        {
            ...
            string msg = "";
            if (new EyouSoft.BLL.MemberStructure.BMember().AddDaiLi(UserInfo.GysId,id)>0)
            {
        ...
        private string DelMyDaiLi()
        {
            ...
            string msg = "";
            if (new EyouSoft.BLL.MemberStructure.BMember().DelDaiLi(UserInfo.GysId, id) > 0)
            {
        ...
        protected string GetCaoZuo(object DaiLiId)
        {
            ...
            {
                int num = new EyouSoft.BLL.MemberStructure.BMember().JudgeDaiLi(UserInfo.GysId, DaiLiId.ToString());
                if (num > 0)
                {
