...
{
   [Power(Menu1.财务管理, Menu2.财务管理_充值管理)]
    public partial class ChongZhiList : EyouSoft.Common.Page.WebmasterPageBase
   {
      ...
      private void PageInit()
      {
         ...
         Model.TransactionCate = EyouSoft.Model.Enum.TCate.充值;
         ...
         BindExportPage();*/
          ...
          chaXun.JinE1 = Utils.GetDecimalNull(Utils.GetQueryStringValue("txtJinE1"));
          chaXun.JinE2 = Utils.GetDecimalNull(Utils.GetQueryStringValue("txtJinE2"));
          chaXun.ChongZhiShiJian1 = Utils.GetDateTimeNullable(Utils.GetQueryStringValue("txtChongZhiShiJian1"));
          chaXun.ChongZhiShiJian2 = Utils.GetDateTimeNullable(Utils.GetQueryStringValue("txtChongZhiShiJian2"));
