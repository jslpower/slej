        ...
        <asp:PlaceHolder runat="server" ID="phdefaultTr">
            <tbody class="tempRow">
                <tr>
                    ...
                    <td align="center">
                        <input type="text" name="txt_qujin" class='inputtext formsize120' value="" />
                    </td>
                    <td align="center">
                        <input type="text" name="txtTraffic" class="inputtext formsize120">
                    </td>
                    <td align="center">
                        <span class="journeyHotel">
                            <input type="text" class="inputtext formsize120" name="txtHotelName" />
                        </span>
                    </td>
                    <td align="center">
                        <input type="text" name="eatFrist" value="" class="inputtext formsize120" />
                    </td>
                    <td align="center" rowspan="3">
                        <a href="javascript:void(0)">
                            <img src="/images/webmaster/charuimg.gif" class="insertbtn" height="20" width="48"></a>&nbsp;
                        <a href="javascript:void(0)">
        ...
        <asp:Repeater ID="rptJourney" runat="server">
            <ItemTemplate>
                <tbody class="tempRow">
                    <tr>
                        <td align="center" rowspan="3">
                            D<b class="index"><%#Container.ItemIndex+1 %></b>
                        </td>
                        <td align="center">
                            <input type="text" name="txt_qujin" class="inputtext size170" value='<%#Eval("QuJian") %>' />
                        </td>
                        <td align="center">
                            <input type="text" name="txtTraffic" class="inputtext size170" value="<%#Eval("JiaoTong") %>">
                        </td>
                        <td align="center">
                            <span class="journeyHotel">
                                <input type="text" class="inputtext size170" name="txtHotelName" value="<%#Eval("ZhuSu") %>" /></span>
                        </td>
                        <td align="center">
                            <input type="text" name="eatFrist" value="<%#Eval("YongCan") %>" class="inputtext formsize120" />
                        </td>
                        <td align="center" rowspan="3">
                            <a href="javascript:void(0)">
                                <img src="/images/webmaster/charuimg.gif" class="insertbtn" height="20" width="48"></a>&nbsp;
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="center">
                            ...
                            <%#Eval("FilePath").ToString().Trim() != "" ? "<div data-class='span_journey_file' class='upload_filename'><a target='_blank' href='" + Eval("FilePath").ToString() + "'><img height='100' width='160' alt='' class='addpic img' style='vertical-align:bottom' src='" + Eval("FilePath").ToString() + "' /></a><a href='javascript:void(0);' title='删除附件' onclick='Journey.RemoveFile(this);'><img src='/images/webmaster/cha.gif' border='0'></a> </div>" : ""%>
                        </td>
                    </tr>
                </tbody>
            </ItemTemplate>
