...
<body>
    ...
    <table width="970" border="0" align="center" cellpadding="0" cellspacing="1" style="margin-top: 10px;">
        <tr class="odd">
            ...
            <td width="330" align="left">
                <asp:DropDownList ID="ddlClassId" runat="server" Width="100px" CssClass="inputselect" valid="required" 
                    errmsg="请选择类别">
                </asp:DropDownList>
            </td>
        </tr>
        ...
        <tr class="odd">
            ...
            <td colspan="3">
                <asp:TextBox runat="server" ID="txtLinkUrl" CssClass="inputtext formsize260" valid="isUrl" errmsg="URL地址不正确"></asp:TextBox>
            </td>
        </tr>
        <tr class="even">
            <th align="center">
        ...
        <tr class="even">
            ...
            <td colspan="3">
                <asp:DropDownList runat="server" ID="JiBieList" CssClass="inputselect">
                    <asp:ListItem Text="普通会员" Value="0"></asp:ListItem>
                    <asp:ListItem Text="免费代理" Value="1"></asp:ListItem>
                    <asp:ListItem Text="贵宾会员" Value="2"></asp:ListItem>
                    <asp:ListItem Text="代理" Value="3"></asp:ListItem>
                    <asp:ListItem Text="员工" Value="4"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
    ...
    <table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td height="40" align="center" class="tjbtn02">
                <a href="javascript:history.go(-1);" id="linkCancel">
                    返回</a>
            </td>
        </tr>
    </table><br /><br />
            ...
            GoAjax: function(url) {
                ...
                $.newAjax({
                    ...
                    success: function(ret) {
                        if (ret.result == "1") {
                            tableToolbar._showMsg(ret.msg, function() { location.href = '/WebMaster/TravelArticleList.aspx'; });
                        }
                        else {
...
//                $("#<%=hdTitleColor.ClientID %>").val(color);
