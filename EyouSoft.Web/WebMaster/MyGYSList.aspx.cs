...
{
    public partial class MyGYSList : EyouSoft.Common.Page.WebmasterPageBase
    {
        #region 分页参数
        ...
        void initList()
        {
            ...
            //}
            var list = new EyouSoft.BLL.MemberStructure.BMember().GetMyGYS(DaiLiId, pageIndex, pageSize, model);
            recordCount = new EyouSoft.BLL.MemberStructure.BMember().GetMyGYSNum(DaiLiId, model);
