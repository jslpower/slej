<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomPrice.aspx.cs" Inherits="EyouSoft.Web.WebMaster.HotelManage.RoomPrice" %>
    ...
    var iPage = {
        ...
        BinRiLi: function() {
            ...
            QGD.initCalendar({
                ...
                firstMonthDate: new Date(Date.parse('<%=string.Format("{0:yyyy\\/MM\\/dd}",startMonth) %>')), //上月
