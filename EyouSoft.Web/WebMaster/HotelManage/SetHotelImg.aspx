<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetHotelImg.aspx.cs" Inherits="EyouSoft.Web.WebMaster.HotelManage.SetHotelImg" %>
        ...
        <table width="100%" border="0">
            <tr>
                <td align="left" valign="top" colspan="3" bgcolor="#E3F1FC" style="padding-left: 20px">
                    <strong>酒店图片上传</strong>
                </td>
            </tr>
            <tr>
                <td align="left" valign="top" colspan="3" style="padding-left: 20px" bgcolor="#E3F1FC">
                    为了更加直观的把贵酒店呈现给客人，请上传整体外观、酒店招牌、大堂及合作房型的图片，餐厅等设施图片请在“更多图片”选项中上传。
                    <br />
            ...
            <tr class="odd">
                ...
                <td bgcolor="#E3F1FC" colspan="2">
                    <asp:Literal runat="server" ID="ltrJiuDianName"></asp:Literal>
                </td>
            </tr>
            <tr class="odd">
            ...
            <tr class="odd">
                ...
                <td bgcolor="#E3F1FC" width="90%" colspan="2">
                    <table>
                        <tr>
                            <td>
                                ...
                                <div id="divPicList">
                                    <ul style="width: 100%; padding: 0px;">
                                        <asp:Repeater runat="server" ID="rptmoreImgList">
                                            <ItemTemplate>
                                                <li id="li<%#Eval("ImgId") %>"
                                                    title=""><a href='<%#Eval("FilePath") %>' target="_blank">
                                                        <img src='<%#Eval("FilePath") %>' alt="" class="upload_img" /></a>
                                                    <input type="hidden" name="hidimgid" value='<%#Eval("ImgId") %>' />
                                                    <span style="display: block; text-align: center; line-height: 20px;">
                                                        <%#EyouSoft.Common.Utils.GetText2(Convert.ToString(Eval("Desc")), 10, true)%>
                                                        <br />
                                                        <a onclick="SetImg.DeleteImg('<%#Eval("ImgId") %>')" href="javascript:void(0)">删除</a>
                                                    </span></li>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        <li></li>
    ...
    var SetImg = {
        ...
        PageInit: function() {
            swfUploadHandler.init({
                ...
                completeFn: function() {
                    ...
                    var url = "/WebMaster/HotelManage/SetHotelImg.aspx?type=xingxiang&dotype=save&imgtype=xingxiang&hotelid=" + '<%=Request.QueryString["hotelid"] %>';
            ...
            swfUploadHandler.init({
                ...
                completeFn: function() {
                    var dotype = '<%=Request.QueryString["dotype"] %>';
                    var url = "/WebMaster/HotelManage/SetHotelImg.aspx?type=more&dotype=save&imgtype=more&hotelid=" + '<%=Request.QueryString["hotelid"] %>';
                    SetImg.GoAjax(url); /*完成上传事件*/
                }
            });
        ...
        DeleteImg: function(id) {
            parent.tableToolbar.ShowConfirmMsg("确定要删除吗？", function() {
                $.newAjax({
                    url: "SetHotelImg.aspx?dotype=deleteimg&imgid=" + id,
                    type: "post",
                    cache: false,
                    dataType: "json",
