<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StrategyThemeList.aspx.cs" Inherits="EyouSoft.Web.WebMaster.Strategy.StrategyThemeList" %>
        ...
        <table width="100%" cellspacing="1" cellpadding="0" border="0">
            <tbody>
                ...
                <asp:Repeater runat="server" ID="rptList">
                    <ItemTemplate>
                        <tr class="<%#Container.ItemIndex%2==0 ? "even":"odd" %>" data-id='<%#Eval("ThemeID") %>'>
                            <td align="center">
    ...
    <script type="text/javascript">
        ...
        var RouteTheme = {
            ...
            BindBtn: function() {
                ...
                RouteTheme.ShowBoxy({ iframeUrl: "/WebMaster/Strategy/StrategyThemeEdit.aspx?action=add", title: "新增旅游攻略主题", width: "550px", height: "180px" });
                    return false;
                })
                $(".update_bar").click(function() {
                    var tid = $(this).closest("tr").attr("data-id");
                    RouteTheme.ShowBoxy({ iframeUrl: "/WebMaster/Strategy/StrategyThemeEdit.aspx?action=edit&tid=" + tid, title: "修改旅游攻略主题", width: "550px", height: "180px" });
                    return false;
                })
                $(".delete_bar").click(function() {
                    var tid = $(this).closest("tr").attr("data-id");
                    var url = "/WebMaster/Strategy/StrategyThemeList.aspx?dotype=delete&tid=" + tid;
                    tableToolbar.ShowConfirmMsg("您确定要删除此主题吗？", function() {
