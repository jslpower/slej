<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StrategyThemeEdit.aspx.cs" Inherits="EyouSoft.Web.WebMaster.Strategy.StrategyThemeEdit" %>
    ...
    <table width="520" cellspacing="1" cellpadding="0" border="0" align="center" style="margin: 20px auto;">
        <tbody>
            ...
            <tr class="odd">
                ...
                <td align="left">
                    <asp:TextBox ID="txtSort" runat="server" Text="0" CssClass="formsize50 inputtext" name="txtSort"></asp:TextBox>
                </td>
            </tr>
            <tr class="odd">
        ...
        var RouteThemeAdd = {
            ...
            BindBtn: function() {
                ...
                $("#<%=btn.ClientID %>").click(function() {
                    ...
                    var ajaxUrl = "/WebMaster/Strategy/StrategyThemeEdit.aspx?" + $.param(data);
