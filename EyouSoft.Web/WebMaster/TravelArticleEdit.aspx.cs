...
{
    public partial class TravelArticleEdit : EyouSoft.Common.Page.WebmasterPageBase
    {
        ...
        private string PageSave(string id, string dotype)
        {
            ...
            model.ArticleText = Utils.EditInputText(this.txtArticleText.Text);
            model.Source = Utils.GetFormValue(this.txtASource.UniqueID);
            model.LinkUrl = Utils.GetFormValue(this.txtLinkUrl.UniqueID);
            model.IsFrontPage = !string.IsNullOrEmpty(Utils.GetFormValue(this.ddlIsFrontPage.UniqueID)) ? (bool?)(Utils.GetFormValue(this.ddlIsFrontPage.UniqueID) == "1" ? true : false) : false;
            model.IsHot = !string.IsNullOrEmpty(Utils.GetFormValue(this.ddlIsHot.UniqueID)) ? (bool?)(Utils.GetFormValue(this.ddlIsHot.UniqueID) == "1" ? true : false) : false; ;
            ...
            model.JiBie = (EyouSoft.Model.Enum.GongGaoJiBie)Utils.GetInt(Utils.GetFormValue(this.JiBieList.UniqueID));
