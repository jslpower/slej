...
//                $("#tr_JinE").html(html);
//            }
            var html1 = "<strong>门市费：<font class=\"font14 fontblue\" style=\"text-decoration:line-through\">" + jsonZ.Zjc.toFixed(2) + "</font> 元；&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;优惠费：<font class=\"font14 fontblue\">" + jsonZ.Zhy.toFixed(2) + "</font>元；";
