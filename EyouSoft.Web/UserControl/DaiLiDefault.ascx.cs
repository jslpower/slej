    ...
    public partial class DaiLiDefault : System.Web.UI.UserControl
    {
        ...
        private void InitHotel()
        {
            ...
            if (list != null && list.Count > 0)
            {
                if (list.Count > 4)
                {
                    rpt_Hotel.DataSource = _list;
                }
                else
                {
                    rpt_Hotel.DataSource = list;
                }
                rpt_Hotel.DataBind();
            }
        ...
        protected void InitHuiYuanShopping()
        {
            ...
            if (!string.IsNullOrEmpty(dailiId))
            {
                ...
                var list = new EyouSoft.BLL.MallStructure.BShangChengShangPin().GetDaiLiList(20, 1, ref recordCount, model);
                if (list != null && list.Count > 0)
                {
            ...
            else
            {
                ...
                var list = new EyouSoft.BLL.MallStructure.BShangChengShangPin().GetList(20, 1, ref recordCount, model);
                if (list != null && list.Count > 0)
                {
                    rpt_HuiYuanShopping.DataSource = list;
                    rpt_HuiYuanShopping.DataBind();
