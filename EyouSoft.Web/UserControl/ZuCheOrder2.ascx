<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ZuCheOrder2.ascx.cs"
    Inherits="EyouSoft.Web.UserControl.ZuCheOrder2" %>
<div class="car_side01 fixed">
    <div class="car_table">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="botborder font14">
            <tr>
                ...
                <td colspan="3">
                    ...
                    (<span style="color: Red; font-size: 10px;">注:当天单程500公里内</span>)
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td width="82px">
                    <select id="txtCarNumber" name="txtCarNumber" style="width: 60px;" onkeyup="this.value=this.value.replace(/[^\d]/g,&#39;&#39;)">
            ...
            <tr>
                <td name="abc" style="padding-left: 25px">
                    <span id="Starting">往返地址：&nbsp;&nbsp;</span><input type="text" id="txtfirstPlace"
                        name="txtfirstPlace" data-name='txtPlace' class="input_bluebk formsize240" value="浙江省杭州市武林广场" valid="required"
                        errmsg="请输入往返地址!" /><a class="btn001" href="javascript:void(0);"><span>地图选址</span></a>
                </td>
            </tr>
            <tr class="tempRow">
                <td name="td-gongli" style="padding-left: 25px">
                    <em id="Destination">第<span class="tr-number">1</span></em>目的地：<input type="text"
                        id="txtlastPlace" name="txtlastPlace" data-name='txtPlace' class="input_bluebk formsize240" value="请详细正确填写市县区和道路名称"
                        valid="required" errmsg="请输入第一目的地!" /><a class="btn001" href="javascript:void(0);"><span>地图选址</span></a><span
                            style="margin-left: 20px"><em class="danjiedansong" style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em>增加公里数：</span><input type="text" readonly="readonly" name="txtGongli"
                                id="Text1" onkeyup="this.value=this.value.replace(/[^\d]/g,&#39;&#39;)" class=" input_bluebk formsize60" />公里
                </td>
            </tr>
            <tr class="tempRow danjie">
                <td name="td-gongli" style="padding-left: 25px">
                    第<span class="tr-number">2</span>目的地：<input type="text" id="Text2" name="txtlastPlace" data-name='txtPlace'
                        class="input_bluebk formsize240" value="请详细正确填写市县区和道路名称" /><a class="btn001" href="javascript:void(0);"><span>地图选址</span></a><span
                            style="margin-left: 20px">增加公里数：</span><input type="text" readonly="readonly" name="txtGongli"
                                id="Text3" onkeyup="this.value=this.value.replace(/[^\d]/g,&#39;&#39;)" class=" input_bluebk formsize60" />公里
                </td>
            </tr>
            <tr class="tempRow danjie">
                <td name="td-gongli" style="padding-left: 25px">
                    第<span class="tr-number">3</span>目的地：<input type="text" id="Text4" name="txtlastPlace" data-name='txtPlace'
                        class="input_bluebk formsize240" value="请详细正确填写市县区和道路名称" /><a class="btn001" href="javascript:void(0);"><span>地图选址</span></a><span
                            style="margin-left: 20px">增加公里数：</span><input type="text" readonly="readonly" name="txtGongli"
                                id="Text5" onkeyup="this.value=this.value.replace(/[^\d]/g,&#39;&#39;)" class=" input_bluebk formsize60" />公里
                </td>
            </tr>
            <tfoot>
                <tr>
                    <td style="padding-left: 25px" align="left" bgcolor="#f3f3f3" class="padd">
                        <em class="danjie" style="padding-left: 65px;"><a href="javascript:void(0);" class="add_btn addbtncontract">
                            添加目的地</a></em>
                    </td>
                </tr>
            </tfoot>
                ...
                <td align="left" colspan="4" style="padding-left: 25px">
                    <span id="quancheng"></span><span>全程往返总公里数：<input id="endchufa" type="hidden" />
                        <input type="text" readonly="readonly" name="wangfan" onkeyup="this.value=this.value.replace(/[^\d]/g,&#39;&#39;)"
                            id="wangfan" class=" input_bluebk formsize80" />公里</span>
                </td>
            </tr>
            <tr>
                <td align="left" colspan="4" style="padding-left: 25px">
    ...
    <div class="car_map">
    <iframe width="418px" id="map1" height="287px" frameborder="0"  scrolling="no"></iframe>
    </div>
</div>
<%if (ShowOrHidden == 0)
  { %>
...
<table id="XiangxiShuJu" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td style="padding-left: 25px; padding-top: 20px;" colspan="4">
            乘车联系人：<input id="txtChengCheName" type="text" class="input_bluebk" style="width: 220px;"
                name="txtChengCheName" valid="required|isName" errmsg="乘车联系人姓名不能为空!|请填写正确的乘车人姓名,不能有数字!" />
            <em style="padding-left: 90px;">乘车人联系手机：<input id="txtChengCheTel" type="text" class="input_bluebk"
                style="width: 230px;" name="txtChengCheTel" valid="required|isMobile" errmsg="乘车联系人手机不能为空!|请填写正确乘车联系人手机!" /></em>
        </td>
    </tr>
    <tr>
        <td style="padding-left: 25px; width: 40px;">
            备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：
        </td>
        <td colspan="3" style="padding-top: 10px;">
            <textarea id="txtBeiZhu" name="txtBeiZhu" cols="20" rows="6" style="height: 30px;
                width: 645px;" class="input_bluebk"></textarea>
        </td>
    </tr>
</table>
    ...
    $(function() {
        ...
        $("#txtfirstPlace").blur(function() {
            if ($('#txtfirstPlace').val() == "") { $('#txtfirstPlace').val("浙江省杭州市武林广场"); }
                ...
                var start = $('#txtfirstPlace').val();
                var end = $("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(0).val();
                if (end != "" && end != "请详细正确填写市县区和道路名称") {
                    initeMap(start, end, $("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(0));
                }
                ...
                if (zongdian != "" && zongdian != "请详细正确填写市县区和道路名称") {
                    initeMap1(start, zongdian, $("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(0));
                }
            }
        });
    ...
    setStart:"",
        radioClick: function() {
            $("input[name=radioSelect]").change(function() {
                ...
                else
                {
                    ...
                    $(".danjie").css("display","");  
                    $(".danjiedansong").css("display","none");   
                }
                OrderPage.Show();
            });
        },
        ...
        InputChange: function(obj) {
            ...
            var mudicount =$(".tr-number").length;
                ...
                var nextend = $("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(num).val();
                if(nextend !="请详细正确填写市县区和道路名称" && nextend !="")
                {
                $("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(num).blur();
                }
//                var nextend = $("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(num).val();
//                var objetv =$("td[name=td-gongli]").find("input[name=txtlastPlace]").eq(num);
//                if(nextend !="请详细正确填写市县区和道路名称" && nextend !="")
//                {
//                   alert(objetv);
//                   initeMap(first, end, $(objetv));
//                }
                OrderPage.Html();
            });
                ...
                for (var zongnum = 0; zongnum < mudicount; zongnum++) {
                    ...
                    if (zongdian != "请详细正确填写市县区和道路名称" && zongdian != "") {
                        if ($("td[name=td-gongli]").find("input[name=txtGongli]").eq(zongnum).val() == "0" || $("td[name=td-gongli]").find("input[name=txtGongli]").eq(zongnum).val()=="") {
                            html = html1 = "<strong style=\"color:red; font-size:16px; font-weight:bold;\">第" + (zongnum + 1) + "目的地地址无法计算出两地距离，请重新选择地址</strong>";
                            $("#tr_JinE").html(html);
...
//            }
    ...
    function AddMapLuxian(xingcheng)
    {
    var mapurl = "/XingCheng.aspx?dibiao="+xingcheng;
        document.getElementById('map1').src = mapurl;
//      // 百度地图API功能
//      $("#car_map").html("");
//    var map = new BMap.Map("car_map");
//    var didian = new Array();
//    didian = xingcheng.split(',');
//    map.enableKeyboard();
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var aid = $(this).closest("tr").find("[data-name=txtPlace]").attr("id");
            Boxy.iframeDialog({
