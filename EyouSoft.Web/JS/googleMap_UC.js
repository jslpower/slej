...
GRulerControl.prototype.initialize = function(map) {
    ...
    img.src = me.Domain + '/Images/webmaster/google_search.png';
    ...
    img1.src = me.Domain + '/Images/webmaster/search.gif';
    img1.id = 'btn_Search';
        ...
        if (result.Status.code == G_GEO_SUCCESS) {
            for (var i = 0; i < result.Placemark.length; i++) {
                ...
                if (i == 0) {   
                    ...
                    var ico = new GIcon(G_DEFAULT_ICON, me.Domain + '/Images/webmaster/googleMapRed.png');
