...
var LoadingImg = {
    _imageUrl:"/images/loadingnew.gif",
    stringPort: "",
    getImageUrl:function(){
        return this.stringPort+this._imageUrl;
    }
    ,
    //-----显示正在加载 
    ShowLoading: function(divId) {
        ...
        if (obj != null) {
            obj.innerHTML = "<img id='_img_loading_" + divId + "' src='"+this.stringPort+"/images/loadingnew.gif' border='0' /><br />&nbsp;正在加载...&nbsp;";
        }
    },
...
//do image preload.
//new image().src =LoadingImg.getImageUrl(); 