...
var QGD = {
  ...
  '</tr>' +
  '<tr>' +
    '<td width="415" valign="top" ><div id="thisMonthCalendar"></div></td><td width="10" ></td>' +
    '<td width="415" valign="top"><div id="nextMonthCalendar"></div></td>' +
  '</tr>' +
'</tbody></table>',
    p: parent,
    //页面元素配置信息
    ...
    _createCalendarContainer: function() {
        ...
        $("#linkPreMonth").html("＜＜" + (this.SDConfig.CM) + "月");
        $("#linkNextMonth").html((this.SDConfig.NM) + "月＞＞");
    ...
    createCalendarDays: function(isNextMonth) {
        ...
        do {
            ...
            var tdTourstr = '<td height="60px" class="riqi" id=' + thisDate + ' bgcolor="#ffffff" align="center"><font class="sizdate">' + sd + '</font></td>';
