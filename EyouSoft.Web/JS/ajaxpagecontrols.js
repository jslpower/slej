...
AjaxPageControls.gotoURL = function(obj) {
    var url = window.location.pathname;
    var urlParms = this.getUrlParms(["page"]);
    var pageindex = $(obj).prev().find("[name=ajaxPageSelectPage]").val();
...
AjaxPageControls.selectPage = function() {
    if (this.config.pageIndex != this.config.pageCount) {
        var nextPageIndex = this.config.pageIndex + 1;
        return '<span>&nbsp;&nbsp;到&nbsp;&nbsp;<input type="text" name="ajaxPageSelectPage"  class="input-style page_input" style="width:37px;"  />&nbsp;&nbsp;页&nbsp;&nbsp;</span><a href="javascript:;" class="pag_btn" name="ajaxSelectBtn"  onclick="AjaxPageControls.gotoURL(this)">前往</a> ';
    } else {
        return '';
    }
}
