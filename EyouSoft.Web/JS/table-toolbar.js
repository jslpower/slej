var tableToolbar = {
        ...
        if (this.deleteB.length > 0) {
            this.deleteB.click(function() {
                ...
                if (isSucess) {
                    ...
                    var _html = '<div style="padding: 10px 0 20px 10px;cursor: default;"><h1 style="margin:10px 5px;font-size:14px;font-weight:bold;"><img src="/Images/webmaster/y-tanhao.gif" style=" vertical-align:middle; margin-right:5px;" />  {{msg}}</h1><input type="button" onclick="$.unblockUI();return false;"  value="取消" " style="width:64px; height:24px; border:0 none; background:url(/Images/webmaster/cx.gif);" /> <input type="button" id="BLOCKUI_YES" value="确 定" style="width:64px; height:24px; border:0 none; margin-left:20px; background:url(/Images/webmaster/cx.gif);" /> </div>';
                    $.blockUI({
    ...
    ShowConfirmMsg: function(msg, callbackfun, callbackfun2) {
        var confirmMsg = msg;
        var _html = '<div style="padding: 10px 0 20px 10px;cursor: default;"><h1 style="margin:10px 5px;font-size:14px;font-weight:bold;"><img src="/Images/webmaster/y-tanhao.gif" style=" vertical-align:middle; margin-right:5px;" />  {{msg}}</h1><input type="button" id="BLOCKUI_NO" value="取消" " style="width:64px; height:24px; border:0 none; background:url(/Images/webmaster/cx.gif);" /> <input type="button" id="BLOCKUI_YES" value="确 定" style="width:64px; height:24px; border:0 none; margin-left:20px; background:url(/Images/webmaster/cx.gif);" /> </div>';
        $.blockUI({
            message: _html.replace(/{{msg}}/, confirmMsg),
            css: { backgroundColor: "#E9F4F9", borderColor: "#00446b", borderWidth: '1px', cursor: "pointer", color: "#ed0000", width: '375px' }
        });
