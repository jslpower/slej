...
{
    public partial class DuanXianOrder : ClientModelViewPageBase<EyouSoft.Model.XianLuStructure.MOrderChaXunInfo>
    {
        ...
        public void GetOrderList(string AgencyId)
        {
            ...
            Model.RouteType = EyouSoft.Model.Enum.AreaType.周边短线;
