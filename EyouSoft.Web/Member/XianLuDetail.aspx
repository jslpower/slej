<%@ Page Title="线路订单详情" Language="C#" MasterPageFile="~/MasterPage/Front3.Master" AutoEventWireup="true" CodeBehind="XianLuDetail.aspx.cs" Inherits="EyouSoft.Web.Member.XianLuDetail" %>
...
<div class="user_right">
          <div class="title_bar">
            <h4>&gt; 线路订单详情</h4>
          <span>您的位置：<a href="/Default.aspx">首页</a> > <a href="UpdateMember.aspx">会员中心</a> > 我的订单 > 线路订单详情</span></div>
