...
{
    public partial class XianLuOrderList : ClientModelViewPageBase<EyouSoft.Model.XianLuStructure.MOrderChaXunInfo>
    {
        ...
        public void GetOrderList(string AgencyId)
        {
            ...
            if (starttime.Value.Trim() != "")
            {
                ...
                {
                    if (Convert.ToDateTime(endtime.Value.Trim()) >= Convert.ToDateTime(endtime.Value.Trim()))
                    {
                    ...
                    {
                        Model.SXiaDanTime = Convert.ToDateTime(endtime.Value.Trim());
                        Model.EXiaDanTime = Convert.ToDateTime(starttime.Value.Trim());
                    }
                }
            }
            if (AgencyId != "")
