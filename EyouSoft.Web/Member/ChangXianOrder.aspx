<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front2.Master" AutoEventWireup="true" CodeBehind="ChangXianOrder.aspx.cs" Inherits="EyouSoft.Web.Member.ChangXianOrder" %>
            ...
            <input name="Input" value="搜索" type="submit" class="line-s-btn s_btn" />
              ...
              <ItemTemplate>
                   <tr>
                     ...
                     成人价：<%# UtilsCommons.GetGYStijia(EyouSoft.Model.Enum.FeeTypes.国内线路, Convert.ToDecimal(Eval("JSJCR")), Convert.ToDecimal(Eval("SCJCR")), (EyouSoft.Model.Enum.MemberTypes)EyouSoft.Common.Utils.GetInt(((int)Eval("UserType")).ToString())).ToString("f2")%> 元/人<br />
                     儿童价：<%# UtilsCommons.GetGYStijia(EyouSoft.Model.Enum.FeeTypes.国内线路,Convert.ToDecimal(Eval("JSJER")),Convert.ToDecimal(Eval("SCJET")), (EyouSoft.Model.Enum.MemberTypes)EyouSoft.Common.Utils.GetInt(((int)Eval("UserType")).ToString())).ToString("f2") %> 元/人<br />
                     金额：<%#  Convert.ToDouble(Eval("JinE")).ToString("f2")%> 元</td>
                     <%if (isAgency == 1)
                     { %>
                     <td align="left">
                     人数：<%# Eval("ChengRenShu")%>成人<%# Eval("ErTongShu")%>儿童<br />
                     成人价：<%# UtilsCommons.GetGYStijia(EyouSoft.Model.Enum.FeeTypes.国内线路, Convert.ToDecimal(Eval("JSJCR")), Convert.ToDecimal(Eval("SCJCR")), (EyouSoft.Model.Enum.MemberTypes)EyouSoft.Common.Utils.GetInt(((int)HuiYuanInfo.UserType).ToString())).ToString("f2")%> 元/人<br />
                     儿童价：<%# UtilsCommons.GetGYStijia(EyouSoft.Model.Enum.FeeTypes.国内线路, Convert.ToDecimal(Eval("JSJER")), Convert.ToDecimal(Eval("SCJET")), (EyouSoft.Model.Enum.MemberTypes)EyouSoft.Common.Utils.GetInt(((int)HuiYuanInfo.UserType).ToString())).ToString("f2")%> 元/人<br />
