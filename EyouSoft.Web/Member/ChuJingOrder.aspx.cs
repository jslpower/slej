...
{
    public partial class ChuJingOrder : ClientModelViewPageBase<EyouSoft.Model.XianLuStructure.MOrderChaXunInfo>
    {
        ...
        public void GetOrderList(string AgencyId)
        {
            ...
            Model.RouteType = EyouSoft.Model.Enum.AreaType.出境线路;
