    ...
    public partial class receive : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (f.VerifySignature(result, SignatureByte))
            {
                ...
                {
                    /*
                     var dingDanLeiXiang = (EyouSoft.Model.Enum.DingDanLeiBie?)Utils.GetEnumValueNull(typeof(EyouSoft.Model.Enum.DingDanLeiBie), Utils.GetQueryStringValue("type"));//订单类型
                     */
                    ...
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.商城订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.线路订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.线路订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.酒店订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.酒店订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.门票订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.门票订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.租车订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.租车订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.团购订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.团购订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.充值订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.充值订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.签证订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.签证订单, payAccount, bankDealId); }
                    else if (DingDanLeiXing == EyouSoft.Model.Enum.DingDanLeiBie.自组团订单)
                    { addResult = insertDetial(DingDanId, EyouSoft.Model.Enum.DingDanLeiBie.自组团订单, payAccount, bankDealId); }
                    ...
                    if (addResult)
                    {
                        switch (DingDanLeiXing)
                        {
                            ...
                            case EyouSoft.Model.Enum.DingDanLeiBie.门票订单:
                                ...
                                //门票出票接口
                                bll.SubmitTicketsInterface(orderId);
