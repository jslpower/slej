...
{
    public partial class TuanGouTJ : Common.Page.HuiYuanPageBase
    {
        ...
        void initPage()
        {
            ...
            if (HuiYuanInfo != null)
            {
                ...
                lblChanPinJiaGe.Text = Convert.ToInt32(chanpin.GroupPrice).ToString();
        ...
        void BaoCun()
        {
            ...
            Ordermodel.ProductNum = Convert.ToInt32(ChanPinShuLiang.Text);
            ...
            Ordermodel.PeopleMobile = Utils.GetFormValue(txtShouJi.UniqueID);
            Ordermodel.PeopleName = Utils.GetFormValue(txtShouHuoRen.UniqueID);
            Ordermodel.ProductID = id;
            Ordermodel.Peopleaddress = Utils.GetFormValue(UserAddress.UniqueID) + Utils.GetFormValue(txtDiZhi.UniqueID);
