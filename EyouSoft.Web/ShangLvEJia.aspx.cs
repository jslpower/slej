...
{
    public partial class ShangLvEJia : Common.Page.WebPageBase
    {
        #region 分页参数
        ...
        void initList()
        {
            ...
            serchModel.modelTp = EyouSoft.Model.Enum.ModelTypes.天下商旅E家;
        ...
        {
            int itemCount = 0;
            IList<MLianMengLeiBie> list = new EyouSoft.BLL.MallStructure.BLianMeng().GetList(1000, 1, ref itemCount, new MLianMengLeiBieSer() { modelTp = EyouSoft.Model.Enum.ModelTypes.天下商旅E家 });
            if (list != null && list.Count > 0)
            {
        ...
        private void InitAd()
        {
            ...
            //首页轮播图
            var top = bll.GetList(5, AdvArea.天下商旅E家);
