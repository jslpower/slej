...
<body>
    ...
    <div class="msg_box">
        <div class="contact down_jiantou">
            <!------点击后up_jiantou------>
            <ul class="clearfix">
             <li class="box"><span class="radiusl"><img src="<%= uTouXiang%>"></span><em class="font_yellow">外联：</em><asp:Literal ID="UName" runat="server"></asp:Literal></li>
             <li class="box"><span class="radiusl"><img src="<%= slTouXiang%>"></span><em class="font_yellow">客服：</em><%= slname%></li>
            </ul>
        </div>
