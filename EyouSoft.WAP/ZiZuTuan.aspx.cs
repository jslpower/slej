        ...
        void initPage()
        {
            ...
            if (zutuanmodel != null)
            {
                ...
                for (int i = 0; i < renshenmenshi.Length; i++)
                {
                    ...
                    RSBXList += "<a href=\"javascript:void(0);\" data-class=\"rsbxc\" data-value=\"" + renshenmenshi[i] + "\" data-cb=\"" + renshenjia[i] + "\">" + renshenmenshi[i] + "</a>";
                }
                ...
                for (int i = 0; i < jiaotongmenshi.Length; i++)
                {
                    ...
                    JTBXList += "<a href=\"javascript:void(0);\" data-class=\"jtbxc\" data-value=\"" + jiaotongmenshi[i] + "\" data-cb=\"" + jiaotongjia[i] + "\">" + jiaotongmenshi[i] + "</a>";
                }
