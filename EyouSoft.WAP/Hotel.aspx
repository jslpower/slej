...
<body>
    ...
    <div class="warp">
        ...
        <div class="user_form h_form mt10">
            <ul>
               <li class="R_jiantou2" > <!-----点击后的li样式是down_jiantou------->
    ...
    <div class="user-mask" data-name="area" data-class="searchdiv" style="display: block;
        ...
        <div class="hotel-mask-cnt box" style="margin-top: 0; height: 300px; position: absolute;
            ...
            <div class="place_box clearfix padd10">
                <div id="fdibiao" class="place_list box" style="top:0px; bottom:0px;  left:0px;overflow: hidden; position: absolute;">
                    <ul id="AreaNameList">
                    </ul>
                </div>
                <div id="sdibiao" class="place_list2 box" data-class="landdibiao" style="top:0px; bottom:0px;  left:30%; overflow: hidden; position: absolute;">
                    <ul class="dibiao_listTab">
                    </ul>
                </div>
                <div id="tdibiao" class="star_box box" data-class="dibiao" style="width: 40%; top:0px; right:0px;bottom:0px; overflow: hidden; position: absolute;">
