...
<body>
    ...
    <div class="warp">
        ...
        <div class="jq_cont">
            ...
            <p>
                数量：<span class="number"><i class="num-minus"></i><input id="lblNum" name="lblNum" type="tel" value="<%= goumainum%>"><i class="num-add"></i></span>(最多可购买<asp:Literal ID="shengyushu" runat="server"></asp:Literal>份)</p></p>
            <p>
