                        ...
                        <ItemTemplate>
                            <li><a href="/JingQuXX.aspx?ScenicId=<%#Eval("ScenicId")%>">
                                ...
                                <dl>
                                    ...
                                    <dd class="wid R">
                                        会员：<span class="font_yellow">¥<%# EyouSoft.BLL.HotelStructure.BHotel2.CalculateFee((decimal)Eval("SettlementPrice"), (decimal)Eval("WebPrice"), EyouSoft.Model.Enum.MemberTypes.普通会员, (EyouSoft.Model.SystemStructure.MFeeSettings)Eval("FeeSetting"), EyouSoft.Model.Enum.FeeTypes.门票).ToString("0")%></span>起</dd>
                                </dl>
                            </a></li>
                        </ItemTemplate>
                    </asp:Repeater>
                        ...
                        <ItemTemplate>
                            <li><a href="Line_Info.aspx?id=<%#Eval("XianLuId")%>&type=<%= (int)EyouSoft.Model.Enum.AreaType.周边短线 %>">
                                ...
                                <dl>
                                    ...
                                    <dd class="wid R">
                                        <span class="font_yellow">¥<%# getHYJ(EyouSoft.Model.Enum.FeeTypes.周边线路, Eval("Tours"))%></span></dd>
                                </dl>
                            </a></li>
                        </ItemTemplate>
                    </asp:Repeater>
                            ...
                            <li><a href="Line_Info.aspx?id=<%#Eval("XianLuId")%>&type=<%= (int)EyouSoft.Model.Enum.AreaType.国内长线 %>">
                                ...
                                <dl>
                                    ...
                                    <dd class="wid font_gray">
                                        <i class="line_x">¥<%# Convert.ToDecimal(Eval("SCJCR")).ToString("f0")%></i></dd>
                                    <dd class="wid R">
                                        <span class="font_yellow">¥<%# getHYJ(EyouSoft.Model.Enum.FeeTypes.国内线路, Eval("Tours"))%></span></dd>
                                </dl>
                            </a></li>
                        </ItemTemplate>
                    </asp:Repeater>
                            ...
                            <li><a href="Line_Info.aspx?id=<%#Eval("XianLuId")%>&type=<%= (int)EyouSoft.Model.Enum.AreaType.出境线路 %>">
                                ...
                                <dl>
                                    ...
                                    <dd class="wid font_gray">
                                        <i class="line_x">¥<%# Convert.ToDecimal(Eval("SCJCR")).ToString("f0")%></i></dd>
                                    <dd class="wid R">
                                        <span class="font_yellow">¥<%# getHYJ(EyouSoft.Model.Enum.FeeTypes.国际线路, Eval("Tours"))%></span></dd>
                                </dl>
                            </a></li>
                        </ItemTemplate>
                    </asp:Repeater>
