    ...
    public partial class PriceInfo : ControlPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (isLogin)
            {
                ...
                {
                    strbu.AppendFormat("<li class=\"on\"><span class=\"font_yellow\">会员：</span>成人{0}元/人 儿童{1}元/人</li>", UtilsCommons.GetGYStijia(FeeType, JSJCR, CRSCJ, MemberTypes.普通会员).ToString("F0"), UtilsCommons.GetGYStijia(FeeType, JSJET, ETSCJ, MemberTypes.普通会员).ToString("F0"));
                ...
                if (isDisplay)
                {
                    ...
                    {
                        strbu.AppendFormat("<li><span class=\"font_yellow\">会员：</span>成人{0}元/人 儿童{1}元/人</li>", UtilsCommons.GetGYStijia(FeeType, JSJCR, CRSCJ, MemberTypes.普通会员).ToString("F0"), UtilsCommons.GetGYStijia(FeeType, JSJET, ETSCJ, MemberTypes.普通会员).ToString("F0"));
