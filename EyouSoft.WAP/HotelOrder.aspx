...
<div class="warp">
  ...
  <div class="pay">
     <div class="pay_box">
         ...
         <div class="pay_total">到店支付：¥<em id="ZongJinE" name="ZongJinE"><%= ZongJia%></em></div>
...
<script type="text/javascript">
    ...
    $(".num-minus").click(function() {
        ...
        $("#ZongJinE").html(tableToolbar.getFloat(danjia) * tableToolbar.getFloat(getNum.val()) * tableToolbar.getFloat($("#DaysNum").val()));
    ...
    var PageOrder = {
        ...
        GetYouHui: function() {
            ...
            html += "<li>" + hysq + "<span class=\"font_yellow\">第一天入住会员价：</span>" + $("#HuiYuanDanJia").val() + "元/间</li>";
