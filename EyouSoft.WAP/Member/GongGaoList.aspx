<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GongGaoList.aspx.cs" Inherits="EyouSoft.WAP.Member.GongGaoList" %>
	...
	generatedCount = 0;
        ...
        function pullUpAction() {
            setTimeout(function() {
                ...
                $.ajax({
                    type: "Get",
                    url: "/CommonPage/ajaxGongGao.aspx?" + $.param(para),
                    cache: false,
                    ...
                    <div class="u_news">
                        <ul id="linelist">
                            <asp:Repeater ID="rptlist" runat="server">
                                <ItemTemplate>
                                    <a href="GongGaoXX.aspx?id=<%# Eval("ArticleID") %>"><li>
                                        <%# Eval("ArticleTitle")%></li></a>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                        </div>
