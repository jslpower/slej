...
{
    public partial class ajaxXianLuList : Common.Page.WebPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int pageIndex = Utils.GetInt(Utils.GetQueryStringValue("pageindex"), 1);

            int recordCount = 0;
            IList<MXianLuInfo> list = bll.GetXianLus(8, pageIndex, ref recordCount, searchmodel);
