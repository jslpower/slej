...
<body>
    ...
    <div class="warp">
        <div class="jq_search city_s">
            ...
            <div class="search">
                ...
                <span class="city_name"><%= EyouSoft.Common.Utils.GetQueryStringValue("CityName")%></span>
   ...
   <div class="user-mask-i" style=" position:fixed;top:44px; left:0; margin:0;width:100%; box-sizing:border-box; height:140px;">
       
               <div class="paddL paddR">省份：<select id="ddprovince" name="ddprovince" valid="required" errmsg="请选择省份!">
                        </select></div> 
               <div class="paddL paddT paddR">城市：<select id="ddlcity" name="ddlcity" valid="required" errmsg="请选择市区!">
                        </select></div> 
              
               <div class="cent mt10"><a class="y_btn">确定</a></div>
