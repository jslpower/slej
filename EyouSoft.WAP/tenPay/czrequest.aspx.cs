...
{
    public partial class czrequest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (model.IsTradeSuccess)
            {
                ...
                //商户订单号
                string out_trade_no = model.OutTradeNo;// Request.QueryString["out_trade_no"];

                //支付宝交易号
                string trade_no = model.TradeNo;// Request.QueryString["trade_no"];
                ...
                if (addResult)
                {
                    switch (DingDanLeiXing)
                    {
                        ...
                        case EyouSoft.Model.Enum.DingDanLeiBie.充值订单:
                            new EyouSoft.BLL.OtherStructure.BChongZhi().SheZhiYiZhiFu(DingDanId, EyouSoft.Model.Enum.ZhiFuFangShi.微信);
        ...
        bool insertDetial(string orderid, EyouSoft.Model.Enum.DingDanLeiBie DingDanLeiXing, decimal jiaoyi, string jiaoyihao)
        {
            ...
            info.ZhiFuFangShi = EyouSoft.Model.Enum.ZhiFuFangShi.微信;
