...
{
    public partial class ajaxEBao : HuiYuanWapPageBase
    {
        ...
        public void GetChongZhiList()
        {
            ...
            var items = new EyouSoft.BLL.OtherStructure.BChongZhi().GetChongZhis(10, pageindex, ref RecordCount, chaXun);

            if (items != null && items.Count > 0)
            {
                if (RecordCount > (pageindex - 1) * 1)
                {
