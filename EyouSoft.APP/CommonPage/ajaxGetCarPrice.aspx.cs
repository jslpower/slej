...
{
    public partial class ajaxGetCarPrice : System.Web.UI.Page
    {
        ...
        private void selectInfo()
        {
            ...
            string json = "";
            var m = bll.GetModel(zucheID); CarNewInfo model = new CarNewInfo();
            if (m != null)
            {
    ...
    public class CarNewInfo : EyouSoft.Model.ZuCheStructure.MZuCheInfo
    {
