...
<div class="warp">
  ...
  <div class="pay">
     <div class="pay_box">
         ...
         <input id="DaiXiaoDanJia" type="hidden" value="<%=DaiXiaoDanJia%>" />
...
<script type="text/javascript">
    ...
    var PageOrder = {
        ...
        GetYouHui: function() {
            ...
            if (usercate == 1) {
                hysq = "";
                html += "<li class=\"on\">" + hysq + "<span class=\"font_yellow\">优惠：</span>成人" + $("#HuiYuanDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#HuiYuanDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 (当前身份)</li>";
                if (isShow == "True") {
                ...
                gbsq = "";
                gbls = "";
                html += "<li>" + hysq + "<span class=\"font_yellow\">优惠：</span>成人" + $("#HuiYuanDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#HuiYuanDanJia").val()) * tableToolbar.getInt(num)) + "</span>元</li>";
                html += "<li class=\"on\">" + gbsq + "<span class=\"font_yellow\">贵宾：</span>成人" + $("#GuiBingDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#GuiBingDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 (当前身份)</li>";
                if (isShow == "True") {
                    html += "<li>" + dlsq + "<span class=\"font_yellow\">代理：</span>成人" + $("#DaiLiDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#DaiLiDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 " + dlls + "</li>";
                }
                ...
                gbsq = "";
                html += "<li>" + hysq + "<span class=\"font_yellow\">优惠：</span>成人" + $("#HuiYuanDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#HuiYuanDanJia").val()) * tableToolbar.getInt(num)) + "</span>元</li>";
                html += "<li class=\"on\"><span class=\"font_yellow\">代销：</span>成人" + $("#DaiXiaoDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#DaiXiaoDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 (当前身份)</li>";
                if (isShow == "True") {
                    html += "<li>" + dlsq + "<span class=\"font_yellow\">代理：</span>成人" + $("#DaiLiDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#DaiLiDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 " + dlls + "</li>";
                }
            }
                ...
                html += "<li class=\"on\">" + dlsq + "<span class=\"font_yellow\">代理：</span>成人" + $("#DaiLiDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#DaiLiDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 (当前身份)</li>";
                ...
                if (isShow == "True") {
                    html += "<li>" + gbsq + "<span class=\"font_yellow\">贵宾：</span>成人" + $("#GuiBingDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#GuiBingDanJia").val()) * tableToolbar.getInt(num)) + "</span>元 " + gbls + "</li>";
                    html += "<li>" + dlsq + "<span class=\"font_yellow\">代理：</span>成人" + $("#DaiLiDanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#DaiLiDanJia").val()) * tableToolbar.getInt(num)) + "</span>元</li>";
                }
                html += "<li class=\"on\"><span class=\"font_yellow\">员工：</span>成人" + $("#DanJia").val() + "元/人 x " + num + "人 = <span class=\"font_yellow\">" + tableToolbar.getFloat(tableToolbar.getFloat($("#DanJia").val()) * tableToolbar.getInt(num)) + "</span>元 (当前身份)</li>";
            }
            $("#jiagelist").html(html);
        }
    };
