...
namespace EyouSoft.WAP
{
    public partial class HotelList : WebPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            WapHeader1.FenXiangBiaoTi = Utils.GetQueryStringValue("CityName") + "酒店预订";
            WapHeader1.FenXiangMiaoShu = Utils.GetQueryStringValue("CityName") + "酒店预订";
            ...
            else
            {
                ...
                {
                    WapHeader1.FenXiangTuPianFilepath = "http://" + Request.Url.Host + TuPian.F1(list[0].FirstImageAddress, 320, 240);
                    Repeater1.DataSource = list;
                    Repeater1.DataBind();
                }
            }
