...
namespace EyouSoft.WAP.JinRiApi
{
    public partial class JinRi_Notify : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Utils.GetQueryStringValue("t") == "1") ZhiFuDingDan();
        ...
        void ZhiFuDingDan()
        {
            int bllRetCode = new EyouSoft.BLL.JPStructure.BDingDan().SheZhiDingDanYiZhiFu("50979081-88a3-48fa-92c0-996af9199fed", "6d8a7895-5112-46ec-b50d-66c0f4135eb2");
