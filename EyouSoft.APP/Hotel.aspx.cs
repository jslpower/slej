...
namespace EyouSoft.WAP
{
    public partial class Hotel : System.Web.UI.Page
    {
        ...
        private void InitAd()
        {
            ...
            //FenXiangBiaoTi = "酒店预订";
            WapHeader1.FenXiangBiaoTi = "酒店预订";
            //FenXiangMiaoShu = "酒店预订";
            WapHeader1.FenXiangMiaoShu = "酒店预订";
            if (imgList != null && imgList.Count > 0)
            {
                //FenXiangTuPianFilepath = "http://" + Request.Url.Host + TuPian.F1(imgList[0].ImgPath, 640, 200);
                WapHeader1.FenXiangTuPianFilepath = "http://" + Request.Url.Host + TuPian.F1(imgList[0].ImgPath, 640, 200);
            }
