<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="start.aspx.cs" Inherits="EyouSoft.WAP.start" %>
...
<body>
    ...
    <div class="warp">
        ...
        <div class="padd10 cent">
         ...
         <div class="padd10 cent">
            <a href="/default.aspx" class="b_btn">游客浏览</a></div>
            </div>    
        <div class="padd10 cent">
            ...
            <p>
                <img src="/ErWeiMa.aspx?codeurl=http://m.slej.cn" />
            </p>
            <p>
                分享给朋友~~</p>
        </div>
