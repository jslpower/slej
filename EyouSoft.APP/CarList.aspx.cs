...
namespace EyouSoft.WAP
{
    public partial class CarList : System.Web.UI.Page
    {
        ...
        private void InitPage()
        {
            ...
            WapHeader1.FenXiangBiaoTi = "客车包租";
            WapHeader1.FenXiangMiaoShu = "客车包租";
            if (list[0].ZucheInfoImg != null && list[0].ZucheInfoImg.Count > 0)
            {
                WapHeader1.FenXiangTuPianFilepath = "http://" + Request.Url.Host + TuPian.F1(list[0].ZucheInfoImg[0].FilePath, 160, 120);
            }
