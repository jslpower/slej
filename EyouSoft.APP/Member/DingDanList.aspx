                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <div class="user_dindan font16 mt10">
                                    <ul>
                                        <li class="producturl" data-id="<%#Eval("ProductID") %>"><span style="color: rgb(0, 0, 255)">
                                            <%# Eval("OrderName")%>
                                        </span></li>
                                        ...
                                        <%if (orderleibie == 8)
                                          { %><li>租车时间：<%# Eval("ChuFaShiJian")%>
                                              <%}
                                          else if (orderleibie == 4)
                                          {%><li>游玩时间：<%# Eval("ChuFaShiJian")%>
                                              <%}
                                          else if (orderleibie == 5)
                                          {%><li>入住时间：<%# Eval("ChuFaShiJian")%>
                                              <%}
                                          else if (orderleibie == 9)
                                          {%><li>出发时间：<%# Eval("ChuFaShiJian")%>
                                              <%}%></li>
