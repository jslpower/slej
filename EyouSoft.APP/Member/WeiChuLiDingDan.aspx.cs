                ...
                for (int i = 0; i < list.Count; i++)
                {
                    switch (list[i].OrderType)
                    {
                        case DingDanType.长线订单:
                            ...
                            OrderList.Append("<li><p class=\"font16 font_blue\" data-id=\"" + list[i].ProductID + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"Oname\">" + list[i].OrderName + "</p><p class=\"font_blue\" data-orderid=\"" + list[i].OrderId + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"code\">订单编号：" + list[i].OrderCode + "</p>");
                        ...
                        case DingDanType.短线订单:
                            ...
                            OrderList.Append("<span class=\"yd_time\">预订时间：" + list[i].IssueTime + "</span><span class=\"zt_y\">" + list[i].DingDanZT + "</span></li>");
                            OrderList.Append("<li><p class=\"font16 font_blue\" data-id=\"" + list[i].ProductID + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"Oname\">" + list[i].OrderName + "</p>");
                            OrderList.Append("<p class=\"font_blue\" data-orderid=\"" + list[i].OrderId + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"code\">订单编号：" + list[i].OrderCode + "</p><p class=\"color_9\">出行时间：" + list[i].ChuFaShiJian.ToShortDateString() + "</p>");
                        ...
                        case DingDanType.出境订单:
                            ...
                            OrderList.Append("<span class=\"yd_time\">预订时间：" + list[i].IssueTime + "</span><span class=\"zt_y\">" + list[i].DingDanZT + "</span></li>");
                            OrderList.Append("<li><p class=\"font16 font_blue\" data-id=\"" + list[i].ProductID + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"Oname\">" + list[i].OrderName + "</p>");
                            OrderList.Append("<p class=\"font_blue\" data-orderid=\"" + list[i].OrderId + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"code\">订单编号：" + list[i].OrderCode + "</p>");
                        ...
                        case DingDanType.酒店订单:
                            ...
                            OrderList.Append("<span class=\"yd_time\">预订时间：" + list[i].IssueTime + "</span><span class=\"zt_y\">" + list[i].DingDanZT + "</span></li>");
                            OrderList.Append("<li><p class=\"font16 font_blue\" data-id=\"" + list[i].ProductID + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"Oname\">" + list[i].OrderName + "</p>");
                            OrderList.Append("<p class=\"font_blue\" data-orderid=\"" + list[i].OrderId + "\" data-leibie=\"" + (int)list[i].OrderType + "\" data-name=\"code\">订单编号：" + list[i].OrderCode + "</p> <p class=\"color_9\">入住时间：" + list[i].ChuFaShiJian.ToShortDateString() + "</p>");
                            OrderList.Append("<p class=\"color_9\">入住天数：" + (list[i].HuiGuiShiJian - list[i].ChuFaShiJian).Days + "天</p><p class=\"color_9 clearfix\"><span class=\"price floatR\">¥<em>" + list[i].JinE.ToString("f2") + "</em></span>入住人数：" + list[i].OrderNum + "</p>");
