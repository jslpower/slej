<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TiXianList.aspx.cs" Inherits="EyouSoft.WAP.Member.TiXianList" %>
	...
	generatedCount = 0;
        ...
        function pullUpAction() {
            setTimeout(function() {
                ...
                $.ajax({
                    type: "Get",
                    url: "/CommonPage/ajaxTiXian.aspx?" + $.param(para),
                    cache: false,
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <div class="user_dindan font16 mt10">
                                    <ul data-class="gotoxx" data-url="/Member/TiXianXX.aspx?tixianid=<%# Eval("TiXianId")%>">
...
<script type="text/javascript">
    $(function() {
        ...
        $("ul[data-class=gotoxx]").click(function() {
