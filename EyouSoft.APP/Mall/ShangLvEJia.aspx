<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShangLvEJia.aspx.cs" Inherits="EyouSoft.WAP.Mall.ShangLvEJia" %>
...
<body>
    <uc1:WapHeader ID="WapHeader1" runat="server" HeadText="天下商旅e家" />
    <div class="warp">
        <div id="mall_menu">
...
<script type="text/javascript">
    $("#SearchBnt").click(function() {
     ...
     $(".nav_ico").click(function(){           window.location ="/Mall/MallType.aspx?MType=3";        })
