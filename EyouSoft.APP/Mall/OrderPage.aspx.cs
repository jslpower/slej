...
namespace EyouSoft.WAP.Mall
{
    public partial class OrderPage : WebPageBase
    {
        ...
        void BaoCun()
        {
            ...
            model.Address = dizhi;
            model.OrderSite = EyouSoft.Model.Enum.OrderSite.APP;

            var yuming = EyouSoft.Common.Page.HuiYuanPageBase.GetYuMingInfo();
            var JINE = model.ProductNum * UtilsCommons.GetGYStijia(EyouSoft.Model.Enum.FeeTypes.商城, jsj, scj, yuming.UserType);
