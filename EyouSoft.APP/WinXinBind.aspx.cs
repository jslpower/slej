...
namespace EyouSoft.WAP
{
    public partial class WinXinBind : System.Web.UI.Page
    {
        ...
        void BaoCun()
        {
            ...
            string openid = Utils.GetFormValue("openid");
            var bindModel = new EyouSoft.BLL.WeiXin.BWeiXin().GetModel(openid);
            if (bindModel != null) Utils.RCWE(UtilsCommons.AjaxReturnJson("0", "请勿重复绑定"));
