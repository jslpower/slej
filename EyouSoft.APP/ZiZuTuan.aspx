...
<script type="text/javascript">
    ...
    var OrderPage = {
        ...
        ZongJia: function() {
            ...
            var YDaiXiaoJia = tableToolbar.getFloat(zongmoneycb) + tableToolbar.getFloat(tableToolbar.getFloat(tableToolbar.getFloat(zongmoney) - tableToolbar.getFloat(zongmoneycb)) * FeetSeting.Mmfx / 100);
            ...
            var DaiXiaoJia = tableToolbar.getFloat(ChengBenJia) + tableToolbar.getFloat(tableToolbar.getFloat(tableToolbar.getFloat(MenShiJia) - tableToolbar.getFloat(ChengBenJia)) * FeetSeting.Mmfx / 100);
            ...
            if (tableToolbar.getInt(usercate) >= 3) {
                //免费代理
                var zhifucount = $("span[data-name=DaiXiaoMoney]").length;
                for (var i = 0; i < zhifucount; i++) {
                    var zhifujiage = $("span[data-name=DaiXiaoMoney]").eq(i).html();
                    $("span[data-name=DaiXiaoMoney]").eq(i).html(tableToolbar.getFloat(tableToolbar.getFloat(GuiBingJia) - tableToolbar.getFloat(YGuiBingJia) + tableToolbar.getFloat(zhifujiage)));
                }
                ChengRenJia = $("span[data-name=DaiXiaoMoney]").eq(0).html();
                ErTongJia = $("span[data-name=DaiXiaoMoney]").eq(1).html();
                $("#UChengRenJia").val(ChengRenJia);
                $("#UErTongJia").val(ErTongJia);
                $("span[data-name=ZongDaiXiaoMoney]").html(tableToolbar.getFloat(tableToolbar.getFloat(ChengRenJia) * tableToolbar.getInt(ChengRenNum) + tableToolbar.getFloat(ErTongJia) * tableToolbar.getInt(ErTongNum)));
            }
...
//            
            html2 = "<ul><li><span class=\"font_yellow\">优惠：</span>成人"+ huiyuancr +"元/人 x "+ChengRenNum+"人+ 儿童"+ huiyuanet +"元/人 x "+ErTongNum+"人 = <span class=\"font_yellow\">"+hyzj+"</span>元</li>"
