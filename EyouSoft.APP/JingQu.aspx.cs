...
namespace EyouSoft.WAP.JingQu
{
    public partial class JingQu : WebPageBase
    {
        ...
        private void InitAd()
        {
            ...
            WapHeader1.FenXiangBiaoTi = "优惠门票";
            WapHeader1.FenXiangMiaoShu = "优惠门票";
            if (imgList != null && imgList.Count > 0)
            {
                WapHeader1.FenXiangTuPianFilepath = "http://" + Request.Url.Host + TuPian.F1(imgList[0].ImgPath, 210, 70);
            }
